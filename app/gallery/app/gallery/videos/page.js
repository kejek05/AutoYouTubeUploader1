...
// upload sangat ringan pakai XMLHttpRequest
    ...
    <div className="card" style={{ marginTop: 16 }}>
      ...
      >
        <div>
          ...
          <div className="small">
            Upload video ke server, lalu copy path untuk dipakai di Uploads.
          </div>
        </div>
        <div
          style={{
        ...
        >
          <a className="btn" href="/gallery/thumbnails">
            Ke Thumbnails
          </a>
          <a className="btn" href="/uploads">
            Ke Uploads
          </a>
        </div>
      </div>
      ...
      <div className="grid" style={{ marginTop: 12 }}>
        ...
        />
        <button className="btn btn2" type="button" onClick={doUpload}>
          Upload Video
        </button>
